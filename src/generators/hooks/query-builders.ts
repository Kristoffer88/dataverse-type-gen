...
export function generateEntityQueryBuilders(
  ...
  lines.push(`   */`)
  lines.push(`  buildEntityUrl: (id: string, options: EntityOptions<${interfaceName}, typeof ${interfaceName}Meta> = {}): string => {`)
  ...
  lines.push(`   */`)
  lines.push(`  buildListUrl: (options: EntityListOptions<${interfaceName}, typeof ${interfaceName}Meta> = {}): string => {`)
  ...
  lines.push(`   */`)
  lines.push(`  buildCountUrl: (options: Pick<EntityListOptions<${interfaceName}, typeof ${interfaceName}Meta>, '$filter'> = {}): string => {`)
