 ...
 * LogicalName: pum_investmentcategory_statecode
 * Global: false
 * Custom: true
 */
export const PumInvestmentcategoryStatecode = {
    Active: { Value: 0, Label: "Active" },
    Inactive: { Value: 1, Label: "Inactive" }
} as const;

/** Status option values */
export type PumInvestmentcategoryStatecodeValue = (typeof PumInvestmentcategoryStatecode)[keyof typeof PumInvestmentcategoryStatecode]["Value"];

/**
 * Status Reason
 * Reason for the status of the Category
 * LogicalName: pum_investmentcategory_statuscode
 * Global: false
 * Custom: true
 */
export const PumInvestmentcategoryStatuscode = {
    Active: { Value: 1, Label: "Active" },
    Inactive: { Value: 2, Label: "Inactive" }
} as const;

/** Status Reason option values */
export type PumInvestmentcategoryStatuscodeValue = (typeof PumInvestmentcategoryStatuscode)[keyof typeof PumInvestmentcategoryStatuscode]["Value"];


/**
 * Category
 * Entity: pum_investmentcategory
 * Schema: pum_InvestmentCategory
 * Primary Key: pum_investmentcategoryid
 * Primary Name: pum_name
 */
export interface pum_InvestmentCategory {
    ...
    /** Category - Unique identifier for entity instances */
    pum_investmentcategoryid: string;
    /** Name */
    pum_name?: string;
    /** Status - Status of the Category */
    statecode: PumInvestmentcategoryStatecodeValue; // Option set: pum_investmentcategory_statecode
    /** Status Reason - Reason for the status of the Category */
    statuscode?: PumInvestmentcategoryStatuscodeValue; // Option set: pum_investmentcategory_statuscode
...
/**
 * Type-safe expand properties for Category
 * Enables IntelliSense for $expand relationship names
 */
export type pum_InvestmentCategoryExpandableProperties =
    "CreatedBy"
    | "CreatedOnBehalfBy"
    | "ModifiedBy"
    | "ModifiedOnBehalfBy"
...
/**
 * Type-safe expand options for Category
 * Supports both array format and object format with nested options
 */
export type pum_InvestmentCategoryExpand =
    | pum_InvestmentCategoryExpandableProperties[]
    | {
        "createdby"?: {
...
/**
 * Runtime metadata for Category
 * Provides entity schema information for API operations
 */
export const pum_InvestmentCategoryMeta = {
    logicalName: "pum_investmentcategory",
    schemaName: "pum_InvestmentCategory",
    displayName: "Category",
    entitySetName: "pum_investmentcategories",
    isCustomEntity: true,
    primaryKey: {
        logicalName: "pum_investmentcategoryid",
    ...
    optionSets: ["pum_investmentcategory_statecode", "pum_investmentcategory_statuscode"],
    ...
    generated: "2025-08-10T19:04:21.853Z"
} as const;
