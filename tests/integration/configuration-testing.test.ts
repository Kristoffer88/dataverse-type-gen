...
describe('Configuration Options Testing', () => {
  ...
  // DISABLED in v1: Related entities are always generated by default now
  it.skip('should generate related entities when generateRelatedEntities=true', async () => {
  ...
  // DISABLED in v1: maxRelatedEntityDepth option removed - always depth 1
  it.skip('should respect maxRelatedEntityDepth configuration', async () => {
